...
protocol PrefectureNameDelegate: AnyObject {
...
class PrefecturesViewController: UIViewController {
    ...
    weak var delegate: PrefectureNameDelegate?
...
extension PrefecturesViewController: UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        delegate?.Prefecture(name: prefectureNames[indexPath.row])
        // 選択した行の解除
